...
public class PilaPrincipal {
    ...
    private final ArrayList<Cards> cartas;
    private int size;
    ...
    public static void main(String[] args){
        ...
        PilaPrincipal l = new PilaPrincipal();//se inicia el mazo y se revuelven las cartas
        l.ingresarPila();//las ingresa a la pila
